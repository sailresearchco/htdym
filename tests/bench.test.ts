...
const COMBOS: { model: string; chip: string; machine: string | { domain: number; nodes: number } }[] = [
  ...
  { model: 'GLM 5.3',       chip: 'b200',     machine: { domain: 8, nodes: 1 } },
  { model: 'GLM 5.3',       chip: 'tpu-v7x',  machine: '2x2x2' },
  { model: 'GLM 5.3',       chip: 'tpu-v7x',  machine: '2x2x4' },
  // { model: 'GLM 5.3',       chip: 'tpu-v7x',  machine: '2x4x4' },
